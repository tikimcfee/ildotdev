<svelte:head>
	<title>Me in 2026</title>
</svelte:head>

<main>
	<h1>What is tech doing?</h1>
	<div class="article-date">2026-05</div>
	<p class="provenance"><span class="by"><span class="by-human">human</span></span></p>

	<article>
		<div class="aside">
			<p>This is a dangerous stream of conciousness from a human being. Be careful - nothing was generated, tweaked by an AI, proofread, made LLM friendly, SEO optimized, or synergistically cofumbled sinusoidally. I had things I wanted to type for people and this is some of it.</p>
			<p>Here there be little grey cells.</p>
		</div>
